...
class bizuno_payfabric
{
    ...
    public function bizuno_payfabric_plugins_loaded()
    {
        ...
        $this->bizuno_payfabric_gateway_class();
        $this->bizuno_payment_po_method_init();
    ...
    /***************************************************************************************************/
    public function bizuno_payfabric_gateway_class()
    {
...
<?php
    ...
    /***************************************************************************************************/
    public function bizuno_payment_po_method_init() {
